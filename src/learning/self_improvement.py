...
class SelfImprovement:
    ...
    def learn_from_feedback(self, query: str, response: str, rating: int):
        ...
        try:
            ...
            self.performance_stats['average_rating'] = (
    ...
    def get_stats(self):
        ...
        try:
            ...
            if self.performance_stats['total_interactions'] > 0:
                success_rate = (
                    self.performance_stats['successful'] / 
                    self.performance_stats['total_interactions'] * 100
                )
